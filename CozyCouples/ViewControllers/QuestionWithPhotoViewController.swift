...
class QuestionWithPhotoViewController: UIViewController {

    @IBOutlet weak var ReloadBGVIew: UIView!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        DispatchQueue.main.asyncAfter(wallDeadline: .now() + 0.1) {
            ...
            self.ReloadBGVIew.layer.cornerRadius = self.ReloadBGVIew.frame.height/2
            ...
            self.ReloadBGVIew.applyInnerShadows(cornerRadius: self.ReloadBGVIew.frame.height/2)
            ...
            self.ReloadBGVIew.layer.borderWidth = 1
            self.ReloadBGVIew.layer.borderColor = UIColor(hex: "#B377FE").cgColor
    ...
    @IBAction func btnWrongAction(_ sender: UIButton) {
    }
...
extension QuestionWithPhotoViewController: UITextViewDelegate {
